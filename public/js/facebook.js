...
$(document).ready(function () {
    ...
    function getKeywords(format, div) {
        $.get("api/facebook/get.keywords.php", { format: format }, function (data) {
    ...
    $(".results-button").click(function () {
        ...
        $.get("api/facebook/get.results.php", { keyword: keyword, page: '1' }, function (data) {
    ...
    $(".keyword-button").click(function () {
        ...
        $.ajax({
            type: "POST",
            url: "api/facebook/add.keyword.php",
            data: postString,
            success: function () {
                getKeywords('list', '#keywords');
    ...
    $(".del-keyword-button").click(function () {
        ...
        $.ajax({
            type: "POST",
            url: "api/facebook/del.keyword.php",
            data: postString,
            success: function () {
                getKeywords('list', '#keywords');
                resizeBox();
