...
$(document).ready(function () {
    ...
    function getUsers(format) {
        $.get("api/twitter/get.users.php", {format: format},  function (data) {
    ...
    function getUsersKeywords(user_wanted, format, div) {
        $.get("api/twitter/get.users.keywords.php", { user: user_wanted, format: format }, function (data) {
    ...
    $(".results-button").click(function () {
        ...
        $.get("api/twitter/get.results.php", { user: user, keyword: keyword, page: '1' }, function (data) {
    ...
    $(".add-keyword-button").click(function () {
        ...
        $.ajax({
            type: "POST",
            url: "api/twitter/add.user.keyword.php",
            data: postString,
            success: function () {
    ...
    $(".del-keyword-button").click(function () {
        ...
        $.ajax({
            type: "POST",
            url: "api/twitter/del.user.keyword.php",
            data: postString,
            success: function () {
                $("input#keyword").replaceWith('<input type="text" name="keyword" id="keyword"</input>');
                getUsersKeywords(user, 'list', '#user-keywords');
