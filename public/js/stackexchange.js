...
$(document).ready(function () {
    ...
    function getUsers(format) {
        $.get("api/stackexchange/get.users.php", {format: format},  function (data) {
    ...
    function getUsersKeywords(user_wanted, format, div) {
        $.get("api/stackexchange/get.users.keywords.php", { user: user_wanted, format: format }, function (data) {
    ...
    $(".results-button").click(function () {
        ...
        $.get("api/stackexchange/get.results.php", { user: user, keyword: keyword, page: '1' }, function (data) {
    ...
    $(".add-user-button").click(function () {
        ...
        $.ajax({
            type: "POST",
            url: "api/stackexchange/add.user.php",
            data: postString,
            success: function () {
    ...
    $(".del-user-button").click(function () {
        ...
        $.ajax({
            type: "POST",
            url: "api/stackexchange/del.user.php",
            data: postString,
            success: function () {
                getUsers('list');
            }
    ...
    $(".add-keyword-button").click(function () {
        ...
        $.ajax({
            type: "POST",
            url: "api/stackexchange/add.user.keyword.php",
            data: postString,
            success: function () {
    ...
    $(".del-keyword-button").click(function () {
        ...
        $.ajax({
            type: "POST",
            url: "api/stackexchange/del.user.keyword.php",
            data: postString,
            success: function () {
                $("input#keyword").replaceWith('<input type="text" name="keyword" id="keyword"</input>');
                getUsersKeywords(user, 'list', '#user-keywords');
